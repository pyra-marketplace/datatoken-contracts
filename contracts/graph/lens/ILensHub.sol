...
interface ILensHub {
     ...
     */
    function createProfile(LensTypes.CreateProfileParams calldata createProfileParams) external returns (uint256);
    ...
    function setProfileMetadataURIWithSig(
        ...
        LensTypes.EIP712Signature calldata signature
    ) external;
     ...
     */
    function post(LensTypes.PostParams calldata postParams) external returns (uint256);

    /**
     * @custom:meta-tx post.
     */
    function postWithSig(LensTypes.PostParams calldata postParams, LensTypes.EIP712Signature calldata signature)
        external
        returns (uint256);
     ...
     */
    function comment(LensTypes.CommentParams calldata commentParams) external returns (uint256);

    /**
     * @custom:meta-tx comment.
     */
    function commentWithSig(
        LensTypes.CommentParams calldata commentParams,
        LensTypes.EIP712Signature calldata signature
     ...
     */
    function mirror(LensTypes.MirrorParams calldata mirrorParams) external returns (uint256);

    /**
     * @custom:meta-tx mirror.
     */
    function mirrorWithSig(LensTypes.MirrorParams calldata mirrorParams, LensTypes.EIP712Signature calldata signature)
        external
        returns (uint256);
     ...
     */
    function quote(LensTypes.QuoteParams calldata quoteParams) external returns (uint256);

    /**
     * @custom:meta-tx quote.
     */
    function quoteWithSig(LensTypes.QuoteParams calldata quoteParams, LensTypes.EIP712Signature calldata signature)
        external
        returns (uint256);
     ...
     */
    function collectLegacy(LensTypes.LegacyCollectParams calldata collectParams) external returns (uint256);
    ...
    function collectLegacyWithSig(
        LensTypes.LegacyCollectParams calldata collectParams,
        LensTypes.EIP712Signature calldata signature
    ) external returns (uint256);
     ...
     */
    function act(LensTypes.PublicationActionParams calldata publicationActionParams) external returns (bytes memory);

    /**
     * @custom:meta-tx act.
     */
    function actWithSig(
        LensTypes.PublicationActionParams calldata publicationActionParams,
        LensTypes.EIP712Signature calldata signature
     ...
     */
    function getProfile(uint256 profileId) external view returns (LensTypes.Profile memory);
    ...
    function getPublication(uint256 profileId, uint256 pubId)
        external
        view
        returns (LensTypes.PublicationMemory memory);
     ...
     */
    function getPublicationType(uint256 profileId, uint256 pubId) external view returns (LensTypes.PublicationType);

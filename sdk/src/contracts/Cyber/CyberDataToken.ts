...
export interface CyberDataTokenInterface extends utils.Interface {
  functions: {
...
export interface CyberDataToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CyberDataTokenInterface;
  ...
  callStatic: {
    collect(data: BytesLike, overrides?: CallOverrides): Promise<void>;

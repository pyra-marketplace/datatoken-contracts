...
export interface LensFeeCollectModuleInterface extends utils.Interface {
  functions: {
...
export interface LensFeeCollectModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LensFeeCollectModuleInterface;

...
export interface LensLimitedTimedFeeCollectModuleInterface
...
export interface LensLimitedTimedFeeCollectModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LensLimitedTimedFeeCollectModuleInterface;
